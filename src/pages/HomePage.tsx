          ...
          <div className="flex items-center justify-between h-16 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="rounded-full w-11 h-11 text-slate-400 hover:text-white hover:bg-[var(--glass-bg)] border border-transparent hover:border-[var(--glass-border)]"
              >
              ...
              <Button
                ...
                variant="ghost"
                size="icon"
                className="rounded-full w-11 h-11 text-slate-500 hover:text-red-400 hover:bg-red-950/40"
              >
      ...
      <main className="max-w-[1600px] mx-auto px-6 py-16 space-y-16 relative">
        ...
        <div className="p-10 glass-card relative group">
          ...
          <h2 className="text-3xl font-extrabold text-white tracking-tighter mb-4 max-w-xl">
            Центр управления деревом, {user?.display_name}!
          </h2>
        ...
        <div className="glass-card overflow-hidden">
          <div className="border-b border-[var(--glass-border)] p-10 flex items-center justify-between gap-6 flex-wrap">
            ...
            <Button
                onClick={() => setShowAddMember(!showAddMember)}
                className="sm:hidden bg-[var(--secondary)] hover:bg-cyan-300 text-[var(--secondary-foreground)] rounded-full h-12 w-full font-bold shadow-[var(--neon-glow-secondary)]"
              >
                <Plus className="w-5 h-5 mr-2" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-16">
          <StatsCard
            ...
            value="0"
            description="Членов семьи"
          />
          <StatsCard
            icon="🌳"
            title="Глубина истории"
            value="0"
