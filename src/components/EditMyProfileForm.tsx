        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                ...
                <div className="space-y-4 pb-4 border-b border-slate-700">
                    <h3 className="text-md font-semibold text-white">Данные аккаунта</h3>
                    <FormField
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input
                                        ...
                                        placeholder="Как вас называть в приложении"
                                    />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                ...
                <div className="space-y-4">
                    <h3 className="text-md font-semibold text-white">Данные в семейном древе</h3>
